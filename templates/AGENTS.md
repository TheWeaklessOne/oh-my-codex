...
Core workflows include `autopilot`, `mission`, `ralph`, `ultrawork`, `visual-verdict`, `visual-ralph`, `web-clone`, `ecomode`, `team`, `swarm`, `ultraqa`, `plan`, `deep-interview` (Socratic deep interview, Ouroboros-inspired), and `ralplan`.
