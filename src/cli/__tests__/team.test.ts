...
describe('teamCommand status', () => {
  ...
  it('returns pane ids and sparkshell hint in JSON mode', async () => {
    ...
    try {
      ...
      assert.deepEqual(payload.panes?.recommended_inspect_task_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/tasks/task-1.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_approval_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/approvals/task-1.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_state_dirs, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_status_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/status.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_heartbeat_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/heartbeat.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_identity_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/identity.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_inbox_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/inbox.md` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_mailbox_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/mailbox/worker-1.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_shutdown_request_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/shutdown-request.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_worker_shutdown_ack_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/shutdown-ack.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_dir_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_config_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/config.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_manifest_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/manifest.v2.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_events_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/events/events.ndjson` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_dispatch_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/dispatch/requests.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_phase_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/phase.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_monitor_snapshot_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/monitor-snapshot.json` });
      assert.deepEqual(payload.panes?.recommended_inspect_team_summary_snapshot_paths, { 'worker-1': `${canonicalWd}/.omx/state/team/pane-json-team/summary-snapshot.json` });
      ...
      assert.deepEqual(payload.panes?.recommended_inspect_items, [{
        ...
        task_claim_lock_path: `${canonicalWd}/.omx/state/team/pane-json-team/claims/task-1.lock`,
        ...
        task_path: `${canonicalWd}/.omx/state/team/pane-json-team/tasks/task-1.json`,
        approval_path: `${canonicalWd}/.omx/state/team/pane-json-team/approvals/task-1.json`,
        worker_state_dir: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1`,
        worker_status_path: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/status.json`,
        worker_heartbeat_path: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/heartbeat.json`,
        worker_identity_path: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/identity.json`,
        worker_inbox_path: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/inbox.md`,
        worker_mailbox_path: `${canonicalWd}/.omx/state/team/pane-json-team/mailbox/worker-1.json`,
        worker_shutdown_request_path: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/shutdown-request.json`,
        worker_shutdown_ack_path: `${canonicalWd}/.omx/state/team/pane-json-team/workers/worker-1/shutdown-ack.json`,
        team_dir_path: `${canonicalWd}/.omx/state/team/pane-json-team`,
        team_config_path: `${canonicalWd}/.omx/state/team/pane-json-team/config.json`,
        team_manifest_path: `${canonicalWd}/.omx/state/team/pane-json-team/manifest.v2.json`,
        team_events_path: `${canonicalWd}/.omx/state/team/pane-json-team/events/events.ndjson`,
        team_dispatch_path: `${canonicalWd}/.omx/state/team/pane-json-team/dispatch/requests.json`,
        team_phase_path: `${canonicalWd}/.omx/state/team/pane-json-team/phase.json`,
        team_monitor_snapshot_path: `${canonicalWd}/.omx/state/team/pane-json-team/monitor-snapshot.json`,
        team_summary_snapshot_path: `${canonicalWd}/.omx/state/team/pane-json-team/summary-snapshot.json`,
